...
def singleWellCrossPlot(self : 'Plot'):
    #Single well Cross plot
    ...
    for well in self.wellList.GetWells():
        ...
        self.axes.append(fig.add_subplot(spec[0,0]))
        self.axes.append(fig.add_subplot(spec[0,1]))
        self.axes.append(fig.add_subplot(spec[0,2]))
        ...
        self.axes[2].sharey=self.axes[1]
        ...
        self.axes[2].tick_params(labelleft=False, labelright=True)
        ...
        self.rect_selectors[fig.number] = RectangleSelector(self.axes[0], RctOnselect, drawtype='box', button=[1])
